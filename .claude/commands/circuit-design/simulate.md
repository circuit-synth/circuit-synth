...
- Seamless `.simulator()` / `.simulate()` API usage on circuits and subcircuits
...
# Or use the circuit object methods:
# circuit.simulate()
# circuit.simulator()  # alias for .simulate()

# Available analysis methods:
# simulator.dc_analysis()
# simulator.ac_analysis()
# simulator.transient_analysis()
