...
find "/mnt/c/Program Files/KiCad/10.0/share/kicad/symbols" -name "*.kicad_sym" | xargs grep -l "$ARGUMENTS"
# macOS:
find /Applications/KiCad/KiCad.app/Contents/SharedSupport/symbols -name "*.kicad_sym" | xargs grep -l "$ARGUMENTS"
# Linux native:
find /usr/share/kicad/symbols -name "*.kicad_sym" | xargs grep -l "$ARGUMENTS"
```
