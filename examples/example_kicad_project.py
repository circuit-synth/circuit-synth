...
R_22r = Component(
    symbol="Device:R", ref="R", value="22r",
    footprint="Resistor_SMD:R_0603_1608Metric"
)
R_330 = Component(
...
if __name__ == '__main__':
    ...
    with profile("kicad_netlist_generation"):
        circuit.generate_kicad_netlist("example_kicad_project/example_kicad_project.net")
    logger.warning("KiCad netlist generated: example_kicad_project/example_kicad_project.net")
    ...
    with profile("json_netlist_generation"):
        circuit.generate_json_netlist("example_kicad_project/example_kicad_project.json")
    logger.warning("JSON netlist generated: example_kicad_project/example_kicad_project.json")
