...
def complete_stm32_development_board():
    ...
    # VBUS ESD protection
    esd_vbus = Component(
        symbol="Diode:ESD5Z5.0T1G", ref="D1",
    ...
    stm32 = Component(
        symbol="MCU_ST_STM32G0:STM32G030C8T6", ref="U2", # Stock: 54891 units (LCSC: C2040671)
        footprint="Package_QFP:LQFP-48_7x7mm_P0.5mm"
    ...
    cap_stm32_bulk = Component(
        symbol="Device:C", ref="C4", value="10uF",
        footprint="Capacitor_SMD:C_0805_2012Metric"
    )
    cap_stm32_hf1 = Component(
        symbol="Device:C", ref="C5", value="100nF",
        footprint="Capacitor_SMD:C_0603_1608Metric"
    )
    cap_stm32_hf2 = Component(
        symbol="Device:C", ref="C6", value="100nF", 
        footprint="Capacitor_SMD:C_0603_1608Metric"
    )
    ...
    cap_osc_in = Component(
        symbol="Device:C", ref="C7", value="18pF",
        footprint="Capacitor_SMD:C_0603_1608Metric"
    )
    cap_osc_out = Component(
        symbol="Device:C", ref="C8", value="18pF",
        footprint="Capacitor_SMD:C_0603_1608Metric"
    )
    cap_osc_in[1] += osc_in
    ...
    r_power_led = Component(
        symbol="Device:R", ref="R6", value="1K",
        footprint="Resistor_SMD:R_0603_1608Metric"
    )
    led_power = Component(
    ...
    r_status_led = Component(
        symbol="Device:R", ref="R7", value="330R",
        footprint="Resistor_SMD:R_0603_1608Metric"
    )
    ...
    r_button_pullup = Component(
        symbol="Device:R", ref="R8", value="10K",
        footprint="Resistor_SMD:R_0603_1608Metric"
    )
    btn_user = Component(
