...
fn test_circuit_with_description() {
    ...
    assert_eq!(circuit.name, "TestCircuit");
    assert_eq!(circuit.description, Some("A test circuit for validation".to_string()));
}
...
fn test_circuit_properties() {
    ...
    circuit.set_property("voltage".to_string(), "5V".to_string()).unwrap();
    circuit.set_property("frequency".to_string(), "1MHz".to_string()).unwrap();
...
fn test_component_search() {
    ...
    let r1 = Component::new("Device:R".to_string(), Some("R1".to_string()), None, None, None, None, None).unwrap();
    let c1 = Component::new("Device:C".to_string(), Some("C1".to_string()), None, None, None, None, None).unwrap();
    let l1 = Component::new("Device:L".to_string(), Some("L1".to_string()), None, None, None, None, None).unwrap();
...
fn test_hierarchical_circuits() {
    ...
    let comp1 = Component::new("Device:R".to_string(), Some("R1".to_string()), None, None, None, None, None).unwrap();
    let comp2 = Component::new("Device:C".to_string(), Some("C1".to_string()), None, None, None, None, None).unwrap();
