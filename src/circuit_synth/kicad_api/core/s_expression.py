...
class SExpressionParser:
    ...
    def _get_property_positioning(self, lib_id: str, property_name: str):
        ...
        try:
                ...
                if os.path.exists(lib_path):
                    try:
                        ...
                        if "symbols" in lib_data and symbol_name in lib_data["symbols"]:
                            symbol_props = lib_data["symbols"][symbol_name].get("properties", {})
            ...
            logger.debug(f"Error getting property positioning for {lib_id}:{property_name}: {e}")
            return None, None
    ...
    def _symbol_to_sexp(self, symbol: SchematicSymbol) -> List:
        ...
        if symbol.reference:
            ...
            prop.append([sexpdata.Symbol("at"), symbol.position.x + 2.54, symbol.position.y - 1.27, 0])
