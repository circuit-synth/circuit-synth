...
def usb_powered_esp32():
    ...
    regulator_3v3 = Component(
        symbol="Regulator_Linear:NCP1117-3.3_SOT223", ref="U1",
    ...
    esp32 = Component(
        symbol="RF_Module:ESP32-S3-MINI-1", ref="U2",
    ...
    r_status_led = Component(
        symbol="Device:R", ref="R6", value="330R",
        footprint="Resistor_SMD:R_0603_1608Metric" 
    )
    led_status = Component(
        symbol="Device:LED", ref="D4", value="LED",
