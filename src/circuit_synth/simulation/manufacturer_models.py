...
from .models import SpiceModel, ModelLibrary
...
class ManufacturerModels(ModelLibrary):
    ...
    def get_model_source_info(self, model_name: str) -> Dict[str, str]:
        ...
        if "Texas Instruments" in model.manufacturer:
            ...
            source_info["download_url"] = "https://www.analog.com/en/resources/design-tools-and-calculators/ltspice-simulator.html"
            source_info["notes"] += ". Download LTspice which includes ADI models."
        elif "STMicroelectronics" in model.manufacturer:
            source_info["download_url"] = f"https://www.st.com/en/search.html#{model_name}"
            source_info["notes"] += ". Search for the part number and check CAD Resources."
        elif "ON Semiconductor" in model.manufacturer:
            source_info["download_url"] = "https://www.onsemi.com/design/tools-software/webdesigner+/downloadable-tools-and-models"
            source_info["notes"] += ". Check product page or downloadable models section."
        elif "Infineon" in model.manufacturer:
            source_info["download_url"] = "https://www.infineon.com/cms/en/product/promopages/power-mosfet-simulation-models/"
