...
class DebugCLI:
    ...
    def start_session(self, board_name: str, board_version: str = "1.0", symptoms: List[str] = None):
    ...
    def analyze(self):
        ...
        if issues:
            ...
            print("ℹ️  No specific issues identified yet. Add more symptoms or measurements.")
        
        # Search knowledge base
        if self.current_session.symptoms:
            patterns = self.knowledge_base.search_patterns(self.current_session.symptoms)
            if patterns:
    ...
    def close_session(self, resolution: str, root_cause: str):
        ...
        # Calculate duration
        duration = (self.current_session.ended_at - self.current_session.started_at).total_seconds() / 60
...
def main():
    ...
    tree_parser.add_argument('type', choices=['power', 'i2c', 'usb'], 
                            help='Type of troubleshooting tree')
