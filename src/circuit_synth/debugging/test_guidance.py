    ...
    def create_power_troubleshooting_tree() -> TroubleshootingTree:
        ...
        steps = {
            "step_1": TestStep(
                ...
                safety_warnings=["Ensure correct polarity", "Check voltage rating before connecting"],
            ...
            "step_3": TestStep(
                ...
                equipment_needed=[TestEquipment.MULTIMETER, TestEquipment.THERMAL_CAMERA],
                test_points=["Regulator input", "Regulator output", "Enable pin", "Feedback pin"],
                procedure=[
            ...
            "step_4": TestStep(
                ...
                test_points=["Various power test points", "Bulk capacitors", "IC power pins"],
                procedure=[
                ...
                tips=["Check for solder bridges causing shorts", "Verify capacitor polarity"]
            )
        }
        ...
        return TroubleshootingTree(
            ...
            initial_step="step_1",
            steps=steps,
            equipment_list=[TestEquipment.MULTIMETER, TestEquipment.OSCILLOSCOPE, TestEquipment.THERMAL_CAMERA],
            safety_notes=[
    ...
    def create_i2c_troubleshooting_tree() -> TroubleshootingTree:
        ...
        steps = {
            ...
            "step_3": TestStep(
                ...
                equipment_needed=[TestEquipment.OSCILLOSCOPE, TestEquipment.LOGIC_ANALYZER],
                test_points=["SDA", "SCL", "GND"],
                procedure=[
