...
| 15 | ✅ Manually tested | Net split - R3 NET1→NET2 ✓ |
| 16-65 | ⚠️ Automated only | Need manual GUI validation |

**Progress:** 15 of 65 tests manually validated. Issue #403 documents label orientation bug.
