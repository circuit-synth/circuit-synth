...
class TestNetlist1Validation(NetlistValidationBase):
    ...
    def test_component_properties(self):
        ...
        self.assert_component_property(self.json_data["components"], "C1", "value", "0.1uF")
        self.assert_component_property(self.json_data["components"], "C1", "footprint", "Capacitor_SMD:C_0603_1608Metric")
        ...
        self.assert_component_property(self.json_data["components"], "R2", "reference", "R2")
        self.assert_component_property(self.json_data["components"], "R2", "value", "1k")
        self.assert_component_property(self.json_data["components"], "R2", "footprint", "Resistor_SMD:R_0603_1608Metric")
    ...
    def test_net_nodes(self):
        ...
        self.assertIsInstance(output_net, list, "OUTPUT net data should be a list (Structure A)")
        ...
        for net_name in ["+3V3", "/OUTPUT", "GND"]:
            if net_name.startswith("/") and net_name not in self.json_data["nets"]:
                ...
                if local_name in self.json_data["nets"]:
                    ...
                    self.fail(f"Net {net_name} not found in JSON (tried both {net_name} and {local_name})")
            else:
        ...
        for net_name in net_names_to_check:
            ...
            for node in net:
                if node.get("component") in ["R1", "R2", "C1"]:
                    self.assertEqual(node.get("pin", {}).get("type"), "passive",
    ...
    def test_round_trip_conversion(self):
        ...
        self.assertEqual(standardized_original_nets, standardized_exported_nets,
