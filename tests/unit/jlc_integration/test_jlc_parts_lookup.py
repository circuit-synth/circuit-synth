...
class TestJlcPartsInterface:
    ...
    def test_init_without_credentials(self):
        ...
        with patch.dict('os.environ', {'JLCPCB_KEY': 'env_key', 'JLCPCB_SECRET': 'env_secret'}):
...
class TestIntegrationScenarios:
    ...
    def test_full_component_lookup_workflow(self):
        ...
        with patch.object(JlcPartsInterface, 'get_most_available_part') as mock_get_part:
            mock_get_part.return_value = {
                "lcsc_part": "C123456",
                "manufacturer_part": "STM32G030C8T6",
                "manufacturer": "STMicroelectronics",
            ...
            assert enhanced_data["manufacturability_score"] == 1.0  # High stock + basic part
