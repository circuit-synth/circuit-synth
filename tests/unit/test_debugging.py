...
class TestCircuitDebugger:
    ...
    def test_analyze_power_issue(self):
        ...
        assert any(issue.severity == IssueSeverity.CRITICAL or issue.severity == IssueSeverity.HIGH for issue in issues)
    ...
    def test_close_session(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            debugger.close_session(session, "Fixed resistor value", "Wrong resistor installed")
