...
def usb_port(gnd, vbus, usb_dm, usb_dp):
    ...
    n_1 = Net("N$1")
    n_2 = Net("N$2")
    unconnectedn_j1ndpnpadb6_ = Net("unconnected-(J1-D+-PadB6)")
    unconnectedn_j1ndnnpadb7_ = Net("unconnected-(J1-D--PadB7)")
    unconnectedn_j1nsbu1npada8_ = Net("unconnected-(J1-SBU1-PadA8)")
    unconnectedn_j1nsbu2npadb8_ = Net("unconnected-(J1-SBU2-PadB8)")
