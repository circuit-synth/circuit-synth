...
class Test01SimpleResistorWorkflow(unittest.TestCase):
    ...
    def test_kicad_to_python_syncer_initialization(self):
        ...
        self.assertEqual(syncer.code_generator.project_name, "01_simple_resistor_reference")
    ...
    def test_full_round_trip_kicad_python_kicad_python(self):
        ...
        first_generated_kicad = first_python_dir / "01_simple_resistor_reference_generated"
        self.assertTrue(first_generated_kicad.exists(), "First generated KiCad project should exist")
        
        first_generated_sch = first_generated_kicad / "01_simple_resistor_reference_generated.kicad_sch"
        self.assertTrue(first_generated_sch.exists(), "First generated schematic should exist")
        ...
        syncer2 = KiCadToPythonSyncer(
            kicad_project=str(first_generated_kicad),  # Use the generated KiCad as input
        ...
        # Check that both contain the same component
        self.assertIn('ref="R1"', first_python_code, "First Python should have R1 reference")
        self.assertIn('ref="R1"', second_python_code, "Second Python should have R1 reference")
        
        self.assertIn('symbol="Device:R"', first_python_code, "First Python should have Device:R symbol")
        self.assertIn('symbol="Device:R"', second_python_code, "Second Python should have Device:R symbol")
        
        self.assertIn('value="10k"', first_python_code, "First Python should have 10k value")
        self.assertIn('value="10k"', second_python_code, "Second Python should have 10k value")
        
        self.assertIn('footprint="Resistor_SMD:R_0603_1608Metric"', first_python_code, 
                      "First Python should have correct footprint")
        self.assertIn('footprint="Resistor_SMD:R_0603_1608Metric"', second_python_code, 
        ...
        second_generated_kicad = second_python_dir / "01_simple_resistor_reference_generated_generated"
        self.assertTrue(second_generated_kicad.exists(), "Second generated KiCad project should exist")
        
        second_generated_sch = second_generated_kicad / "01_simple_resistor_reference_generated_generated.kicad_sch"
        self.assertTrue(second_generated_sch.exists(), "Second generated schematic should exist")
        
        # Step 8: Compare KiCad schematic content for data integrity
        original_sch_content = (self.reference_project / "01_simple_resistor_reference.kicad_sch").read_text()
        ...
        for check in essential_checks:
            self.assertIn(check, original_sch_content, f"Original schematic should contain {check}")
            self.assertIn(check, first_generated_sch_content, f"First generated schematic should contain {check}")
            self.assertIn(check, second_generated_sch_content, f"Second generated schematic should contain {check}")
        ...
        self.assertIn('project_name="01_simple_resistor_reference_generated"', first_python_code,
                      "First Python should generate with _generated suffix")
        self.assertIn('project_name="01_simple_resistor_reference_generated_generated"', second_python_code,
