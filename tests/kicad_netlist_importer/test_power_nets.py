...
class TestKicadResistorDividerNetlistImporter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.NETLIST_PATH = (
            cls.BASE_DIR / "test_data" / "kicad9" / "netlists" / "netlist8.net"
        )
    ...
    def test_import_resistor_divider_netlist(self):
        ...
        self.assertEqual(
            len(divider_subckt.get("subcircuits", [])),
            0,
            "divider should not have child subcircuits",
        )
        self.assertEqual(
            len(div2_subckt.get("subcircuits", [])),
            0,
            "div2 should not have child subcircuits",
        )
        self.assertEqual(
            len(div3_subckt.get("subcircuits", [])),
            0,
            "div3 should not have child subcircuits",
        )
        ...
        self.assertEqual(
            root_components["R1"]["value"], "10k", "R1 value should be 10k"
        )
        self.assertEqual(root_components["R2"]["value"], "3k", "R2 value should be 3k")
        self.assertEqual(
            root_components["R1"]["footprint"], "Resistor_SMD:R_0603_1608Metric"
        )
        self.assertEqual(
            root_components["R2"]["footprint"], "Resistor_SMD:R_0603_1608Metric"
        )
        ...
        self.assertEqual(
            divider_components["R3"]["value"], "10k", "R3 value should be 10k"
        )
        self.assertEqual(
            divider_components["R4"]["value"], "3k", "R4 value should be 3k"
        )
        self.assertEqual(
            divider_components["R5"]["value"], "0R", "R5 value should be 0R"
        )
        ...
        self.assertEqual(
            div2_components["R7"]["value"], "10k", "R7 value should be 10k"
        )
        ...
        self.assertEqual(
            div3_components["R10"]["value"], "10k", "R10 value should be 10k"
        )
        self.assertEqual(
            div3_components["R11"]["value"], "3k", "R11 value should be 3k"
        )
        ...
        self.assertNotIn(
            "R1", divider_components, "R1 should not be in divider subcircuit"
        )
        self.assertNotIn(
            "R6", divider_components, "R6 should not be in divider subcircuit"
        )
        ...
        self.assertNotIn(
            "+3V3", divider_nets, "+3V3 should NOT exist in divider subcircuit"
        )
        self.assertNotIn(
            "+1V8", divider_nets, "+1V8 should NOT exist in divider subcircuit"
        )
        self.assertNotIn(
            "+12LF", divider_nets, "+12LF should NOT exist in divider subcircuit"
        )
        ...
        self.assertNotIn(
            "+12LF", div2_nets, "+12LF should NOT exist in div2 subcircuit"
        )
        ...
        self.assertIn(
            "vout5v", divider_nets, "vout5v should exist in divider subcircuit"
        )
        ...
        self.assertNotIn(
            "vout1v8", root_nets, "vout1v8 should NOT exist in root circuit"
        )
        self.assertNotIn(
            "vout12v", root_nets, "vout12v should NOT exist in root circuit"
        )
        self.assertNotIn(
            "vout1", divider_nets, "vout1 should NOT exist in divider subcircuit"
        )
        self.assertNotIn(
            "vout1v8", divider_nets, "vout1v8 should NOT exist in divider subcircuit"
        )
        self.assertNotIn(
            "vout12v", divider_nets, "vout12v should NOT exist in divider subcircuit"
        )
        self.assertNotIn(
            "vout1", div2_nets, "vout1 should NOT exist in div2 subcircuit"
        )
        self.assertNotIn(
            "vout5v", div2_nets, "vout5v should NOT exist in div2 subcircuit"
        )
        self.assertNotIn(
            "vout12v", div2_nets, "vout12v should NOT exist in div2 subcircuit"
        )
        self.assertNotIn(
            "vout1", div3_nets, "vout1 should NOT exist in div3 subcircuit"
        )
        self.assertNotIn(
            "vout5v", div3_nets, "vout5v should NOT exist in div3 subcircuit"
        )
        self.assertNotIn(
            "vout1v8", div3_nets, "vout1v8 should NOT exist in div3 subcircuit"
        )
        ...
        self.assertTrue(
            self._check_jumper(divider_nets, "R5", "+5V", "+5V_div1"),
        ...
        self.assertTrue(
            self._check_jumper(div2_nets, "R6", "+1V8", "+1V8"),
        ...
        self.assertTrue(
            self._check_jumper(div3_nets, "R9", "+12LF", "+12_out"),
        ...
        logger.info(
            f"Resistor divider netlist => JSON output written to: {self.OUTPUT_JSON.resolve()}"
        )

    def _check_resistor_divider(
        self,
        nets,
        r_top_name,
        r_bottom_name,
        ...
        return (
            r_top_in_connected
            and r_top_middle_connected
            and r_bottom_middle_connected
            and r_bottom_out_connected
        )
