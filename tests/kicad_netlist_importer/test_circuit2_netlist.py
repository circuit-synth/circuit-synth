...
class TestCircuit2NetlistImporter(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.NETLIST_PATH = cls.BASE_DIR / "test_data" / "kicad9" / "kicad_projects" / "circuit2" / "circuit2.net"
    ...
    def test_import_circuit2(self):
        ...
        print(f"circuit2.net => JSON output written to: {self.OUTPUT_JSON_PATH.resolve()}")
    ...
    def test_match_reference_json(self):
        ...
        expected_json_path = self.BASE_DIR / "test_data" / "kicad9" / "expected_outputs" / "circuit2_expected.json"
