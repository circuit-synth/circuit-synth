...
def load_reference_circuit_json():
    ...
    json_path = project_root / 'reference_circuit-synth' / 'reference_generated' / 'circuit.json'
...
def test_formatter_migration_phase0():
    ...
    output_dir = Path(__file__).parent.parent.parent / 'test_output' / 'formatter_migration'
...
def test_formatter_migration_phase1():
    ...
    test_circuits = [
        ("simple_resistor", {
            "uuid": "simple-test-001",
            "components": [{"reference": "R1", "lib_id": "Device:R", "value": "10k", "x": 50.8, "y": 63.5}]
        }),
        ("multi_component", {
            "uuid": "multi-test-002",
            "components": [
                {"reference": "R1", "lib_id": "Device:R", "value": "10k", "x": 50.8, "y": 63.5},
                {"reference": "C1", "lib_id": "Device:C", "value": "100nF", "x": 76.2, "y": 63.5}
            ]
        })
    ]
    ...
    if harness.migration_status['tests_passed'] == harness.migration_status['tests_run']:
