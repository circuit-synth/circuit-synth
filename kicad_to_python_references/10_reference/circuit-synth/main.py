#!/usr/bin/env python3
"""
10_reference: Real ESP32 dev board (complete example)

This is a copy of the working example project, demonstrating
a complete real-world hierarchical circuit design with:
